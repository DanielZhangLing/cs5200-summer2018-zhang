...
public class WidgetDao extends BaseDao {
	...
	final String CREATE_WIDGET_FOR_PAGE = "INSERT INTO hw2_zhang_ling_summer_2018.Widget (name, width, height, cssClass, cssStyle, text, order, page, type) VALUES (?, ?, ?, ?);";
	final String CREATE_HEADING = "INSERT INTO hw2_zhang_ling_summer_2018.Heading (widget, size) VALUES (?, ?);";
	final String CREATE_HTML = "INSERT INTO hw2_zhang_ling_summer_2018.Html (widget, html) VALUES (?, ?);";
	final String CREATE_IMAGE = "INSERT INTO hw2_zhang_ling_summer_2018.Image (widget, src) VALUES (?, ?);";
	final String CREATE_YOUTUBE = "INSERT INTO hw2_zhang_ling_summer_2018.Youtube (widget, url, sharable, expandable) VALUES (?, ?, ?, ?);";
	final String FIND_ALL_WIDGETS = "SELECT * FROM hw2_zhang_ling_summer_2018.Widget;";
	final String FIND_HEADING_BY_WIDGET_ID = "SELECT * FROM hw2_zhang_ling_summer_2018.Heading WHERE widget = ?;";
	final String FIND_HTML_BY_WIDGET_ID = "SELECT * FROM hw2_zhang_ling_summer_2018.Html WHERE widget = ?;";
	final String FIND_IMAGE_BY_WIDGET_ID = "SELECT * FROM hw2_zhang_ling_summer_2018.Image WHERE widget = ?;";
	final String FIND_YOUTUBE_BY_WIDGET_ID = "SELECT * FROM hw2_zhang_ling_summer_2018.Youtube WHERE widget = ?;";
	final String FIND_WIDGET_BY_ID = "SELECT * FROM hw2_zhang_ling_summer_2018.Widget WHERE id = ?;";
	final String FIND_WIDGET_FOR_PAGE = "SELECT * FROM hw2_zhang_ling_summer_2018.Widget WHERE page = ?;";
	final String UPDATE_WIDGET = "UPDATE hw2_zhang_ling_summer_2018.Widget SET name = ?, width = ?, height = ?, cssClass = ?, cssStyle = ?, text = ?, order = ?, page = ? WHERE id = ?;";
	final String UPDATE_HEADING = "UPDATE hw2_zhang_ling_summer_2018.Heading SET size = ? WHERE widget = ?";;
	final String UPDATE_HTML = "UPDATE hw2_zhang_ling_summer_2018.Html SET html = ? WHERE widget = ?";;
	final String UPDATE_IMAGE = "UPDATE hw2_zhang_ling_summer_2018.Image SET src = ? WHERE widget = ?";;
	final String UPDATE_YOUTUBE = "UPDATE hw2_zhang_ling_summer_2018.Youtube SET url = ?, sharable = ?, expandable = ? WHERE widget = ?";;
	final String DELETE_WIDGET = "DELETE FROM hw2_zhang_ling_summer_2018.Widget WHERE id = ?;";
	final String DELETE_HEADING = "DELETE FROM hw2_zhang_ling_summer_2018.Heading WHERE widget = ?;";
	final String DELETE_HTML = "DELETE FROM hw2_zhang_ling_summer_2018.Html WHERE widget = ?;";
	final String DELETE_IMAGE = "DELETE FROM hw2_zhang_ling_summer_2018.Image WHERE widget = ?;";
	final String DELETE_YOUTUBE = "DELETE FROM hw2_zhang_ling_summer_2018.Youtube WHERE widget = ?;";
	...
	public int createWidgetForPage(int pageId, Widget widget) {
		...
		try {
			...
			pstmt = conn.prepareStatement(CREATE_WIDGET_FOR_PAGE);
	...
	public int createTypeWidget(int widgetId, Widget widget) {
		...
		try {
			...
			case "HEADING":
				pstmt = conn.prepareStatement(CREATE_HEADING);
				pstmt.setInt(2, ((HeadingWidget) widget).getSize());
				break;
			case "HTML":
				pstmt = conn.prepareStatement(CREATE_HTML);
				pstmt.setString(2, ((HtmlWidget) widget).getHtml());
				break;
			case "IMAGE":
				pstmt = conn.prepareStatement(CREATE_IMAGE);
				pstmt.setString(2, ((ImageWidget) widget).getSrc());
				break;
			case "YOUTUBE":
				pstmt = conn.prepareStatement(CREATE_YOUTUBE);
